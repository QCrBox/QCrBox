...
def refine(
    ...
    cif_file_merge_to_unified_by_yml(
        work_cif_path, output_cif_path, input_cif_path, YAML_PATH, command_name, "output_cif_path"
    )
...
def run_commands(input_cif_path: str, output_cif_path: str, cmd_file_path: str, tsc_path: str | None = None):
    input_cif_path = Path(input_cif_path)
    output_cif_path = Path(output_cif_path)
    work_cif_path = input_cif_path.parent / "qcrbox_work.cif"
