...
- Keep system as loosely coupled as possible, oo reduce maintenance overhead observed in previous versions of the software
- Assume a closed single system for server deployment (at least for now), to simplify inter-component communication and reduce attack surfaces
