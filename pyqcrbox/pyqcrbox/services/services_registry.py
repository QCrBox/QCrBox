...
from pyqcrbox.services.orchestrator import ContainerOrchestrator, create_orchestrator
...
QCRBOX_GLOBAL_SERVICES_REGISTRY.register_factory(ContainerOrchestrator, create_orchestrator)
